...
local PremiumList = {
    ...
    LocalPlayer.UserId, -- ID Kamu sendiri (supaya terlihat statusnya)
}

-- ====================================================
-- 2. LOGIKA CEK PREMIUM (Status Only, Bukan Tema)
-- ====================================================
...
-- Cek apakah ID kita ada di dalam daftar
...
-- ====================================================
-- 3. SETUP UI (TEMA TETAP ORIGINAL)
-- ====================================================

WindUI:AddTheme({
    Name = "Neon-Purple-Black",
    Accent = WindUI:Gradient({
        -- TEMA TETAP UNGU (TIDAK BERUBAH)
...
local Window = WindUI:CreateWindow({
    ...
    -- Icon Window berubah jika Premium, tapi warna tetap Ungu
    ...
    Transparent = true,
    Theme = "Neon-Purple-Black", -- Memaksa tema tetap Neon Purple
    Resizable = true,
    HideSearchBar = true, 
    User = {
        Enabled = true,
...
MainSection:Paragraph({
    ...
    -- Tulisan PREMIUM tetap berwarna Emas (RichText) biar keren, tapi UI tetap Ungu
...
local DetailSection = UserTab:Section({ 
    Title = "Account Stats", 
    Side = "Left", 
    Box = "Friends", Desc = onlineFriends .. " Online", Icon = "solar:users-group-rounded-bold" })
